...
# JAVA面试突击
<!-- > 来自江湖人称阳哥的视频：[点我传送](https://www.bilibili.com/video/BV1zb411M7NQ) -->
 - #### JUC多线程及高并发
 ...
 - #### JVM面试
    ...
    - [怎么查看服务器默认垃圾收集器是哪个？生产是如何配置垃圾收集器？谈谈你对垃圾收集器的理解？CMS你知道吗？](java面试突击训练/jvm?id=怎么查看服务器默认垃圾收集器是哪个？生产是如何配置垃圾收集器？谈谈你对垃圾收集器的理解？cms你知道吗？)
...
- #### MySQL性能优化
   - [MySQL安装](mysql/mysql性能优化?id=_1-mysql安装)
